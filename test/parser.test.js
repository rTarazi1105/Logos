...
const syntaxChecks = [
  ["simplest syntactically correct program", "universal : true;"],
  ["multiple statements", "universal : true; negative : false;"],
  ["value declarations", "is_zero : x : \"custom\"; value 0 : is_zero;"],
  ["struct declaration", "struct Coordinate {x:int y:int type:Polar}"],
  ["enum declaration", "struct Coordinate {x:int y:int type:Polar}"],
  ["module with no params, no return type", "mod f() {}"],
  ["module with one param", "mod f(x: int) {}"],
  ["module with two params", "mod f(x: int, y: boolean) {}"],
  ["module with no params + return type", "mod f(): int {}"],
  ["return types", "function f(g: int)->bool {}"],
  ["module types returned", "function f(): (int)->(int)->void {}"],
  ["array type for param", "function f(x: [[[bool]]]) {}"],
