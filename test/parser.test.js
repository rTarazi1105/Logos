...
const syntaxChecks = [
  ...
  ["operation", "operation both : A,B : (A && B) == (A || B)"],
  ["infix", "infix b both"],
  ["property", "property injection : f : "],
  ["struct declaration", "struct Coordinate {x:int, y:int, type:CoordType}"],
  ["enum declaration", "enum CoordType {0:Cartesian, 2:Polar, other:CoordClass}"],
